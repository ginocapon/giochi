#!/usr/bin/env python3
"""
===== BANDI STATICI GARANTITI =====
Bandi nazionali sempre attivi che non cambiano frequentemente.
Questi vengono sempre caricati come base garantita.
"""
...
BANDI_NAZIONALI = [
    ...
    },
    {
        ...
        'percentuale': '45%',
        'scadenza': '31/12/2025',
        'descrizione': 'Credito d\'imposta per investimenti in transizione digitale ed energetica',
    ...
    },
    {
        ...
        'percentuale': '20%',
        'scadenza': '31/12/2025',
        'descrizione': 'Credito imposta per ricerca fondamentale, industriale e sviluppo sperimentale',
        'beneficiari': 'Tutte le imprese',
    ...
    },
    {
        ...
        'regione': 'Nazionale',
        'tipo_contributo': 'credito_imposta',
        'contributo_max': 'Variabile',
        'percentuale': '110%',
        'scadenza': 'Sempre aperto',
        'descrizione': 'Super deduzione 110% costi R&S per brevetti, software, know-how',
        'beneficiari': 'Tutte le imprese',
        'url': 'https://www.mimit.gov.it/it/incentivi/patent-box'
    },
    ...
    # === INVITALIA ===
    {
        ...
        'percentuale': '80%',
        'scadenza': 'Sempre aperto',
        'descrizione': 'Finanziamento a tasso zero per startup innovative. Fino all\'80% a fondo perduto per Sud e donne.',
    ...
    },
    {
        ...
        'percentuale': '80%',
        'scadenza': 'Sempre aperto',
        'descrizione': 'Incentivi per imprese culturali e creative nel Sud',
        'beneficiari': 'Imprese culturali Sud Italia',
        'url': 'https://www.invitalia.it/cosa-facciamo/rafforziamo-le-imprese/cultura-crea'
    },
    {
    ...
    },
    {
        ...
        'percentuale': '75%',
        'scadenza': 'Sempre aperto',
        'descrizione': 'Grandi investimenti industriali e turistici',
        'beneficiari': 'Grandi imprese e PMI',
        'url': 'https://www.invitalia.it/cosa-facciamo/rafforziamo-le-imprese/contratti-di-sviluppo'
    },
    ...
    {
        'titolo': 'SIMEST Fondo 394 - Fiere Internazionali',
        'ente': 'SIMEST',
        'tipo_ente': 'ente_nazionale',
        'regione': 'Nazionale',
        'tipo_contributo': 'tasso_agevolato',
        'contributo_max': '€150.000',
        'percentuale': '10% fondo perduto',
        'scadenza': 'Sempre aperto',
        'descrizione': 'Finanziamento per partecipazione a fiere internazionali',
        'beneficiari': 'PMI esportatrici',
        'url': 'https://www.simest.it/prodotti-e-servizi/finanziamenti-agevolati'
    },
    {
        'titolo': 'SIMEST Fondo 394 - E-commerce',
        'ente': 'SIMEST',
        'tipo_ente': 'ente_nazionale',
        'regione': 'Nazionale',
        'tipo_contributo': 'tasso_agevolato',
        'contributo_max': '€450.000',
        'percentuale': '10% fondo perduto',
        'scadenza': 'Sempre aperto',
        'descrizione': 'Finanziamento per sviluppo e-commerce export',
        'beneficiari': 'PMI esportatrici',
        'url': 'https://www.simest.it/prodotti-e-servizi/finanziamenti-agevolati'
    },
    ...
    # === AGENZIA COESIONE ===
    {
        ...
        'percentuale': '60%',
        'scadenza': '31/12/2025',
        'descrizione': 'Credito imposta per investimenti nelle Zone Economiche Speciali del Sud',
...
def scrape_bandi_statici() -> List[Dict]:
    """Carica i bandi nazionali statici."""
    bandi = []
...
if __name__ == '__main__':
    print("Test Bandi Statici...")
    risultati = scrape_bandi_statici()
